from ema_workbench import Model, SequentialEvaluator, MultiprocessingEvaluator, Policy, Scenario, Samplers
...
if __name__ == "__main__":
    ...
    with SequentialEvaluator(dike_model) as evaluator:
        experiments, outcomes = evaluator.perform_experiments(1, 5, uncertainty_sampling=Samplers.SOBOL)
